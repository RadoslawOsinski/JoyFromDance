package dance.joyfrom.rest.version;
 ...
 */
@RestController
public class JoyFromDanceRestController {

    private static final Logger LOG = LoggerFactory.getLogger(JoyFromDanceRestController.class);
