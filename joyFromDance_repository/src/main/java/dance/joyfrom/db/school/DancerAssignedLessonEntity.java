...
@Table(name = "dancer_assigned_lessons")
public class DancerAssignedLessonEntity {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "dancer_assigned_lessons_s")
    @GenericGenerator(name = "dancer_assigned_lessons_s",
        strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
        parameters = {
            @Parameter(name = "optimizer", value = "pooled-lo"),
            @Parameter(name = "increment_size", value = "1"),
            @Parameter(name = SequenceStyleGenerator.SEQUENCE_PARAM, value = "dancer_assigned_lessons_s"),
        }
    )
    public long getId() {
        return id;
    ...
    public boolean equals(Object o) {
        ...
        DancerAssignedLessonEntity that = (DancerAssignedLessonEntity) o;
